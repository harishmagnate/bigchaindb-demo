...
const charlie = new driver.Ed25519Keypair()
const donald = new driver.Ed25519Keypair()

console.log('charlie: ', charlie.publicKey)
console.log('donald: ', donald.publicKey)
...
const postData = (charlieSeed, donaldSeed) => {
